...
Original file is located at
    https://colab.research.google.com/drive/1yFa9RVxeL3yHuxA7mCfXpLzFzvI_yxKZ
...
#Se normaliza la edad para predecir con Knn, Red PARA ARBOL NO SE NORMALIZA
...
Se uso el KNN y el modelo presenta un error del 12%
"""
